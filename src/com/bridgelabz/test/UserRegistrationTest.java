...
public class UserRegistrationTest {
    ...
    public void whenGivenMobileNumberShouldReturnFalseSecond(){
        UserRegistration userRegistration = new UserRegistration();
        assertFalse(userRegistration.checkMobileNumber("95278727abc"));
    }
    ...
    public void whenGivenPasswordShouldReturnTrue(){
        UserRegistration userRegistration = new UserRegistration();
        assertTrue(userRegistration.checkPassword("Venky018"));
    }
    ...
    public void whenGivenPasswordShouldReturnFalse(){
        UserRegistration userRegistration = new UserRegistration();
        assertFalse(userRegistration.checkPassword("Venkteshxyz@123"));
    }
}